export const DefaultAvatar = ({ size = 32, className = "" }) => {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      />
      <path 
        d="M16 18C11.0492 18 7 21.134 7 25.5C7 26.3284 7.67157 27 8.5 27H23.5C24.3284 27 25 26.3284 25 25.5C25 21.134 20.9508 18 16 18Z" 
        fill="#9CA3AF" 
      />
    </svg>
  );
